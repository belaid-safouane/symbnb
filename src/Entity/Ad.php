 ...
 * @UniqueEntity(
 *  fields={"title"},
 * message="Une autre annince posséde deja ce titre, merci de le modifier"
 * )
 */
class Ad
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 10 caractère !",
     ...
     * @Assert\Length(min=20,minMessage="Votre introduction doit faire plus de  20 caractère")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100,minMessage="Votre description ne peut pas faire moin de  100 caractère")
     */
    private $content;
    ...
    /**
     * Permet d'obtenir desjours qui ne sont pas disponible pour cette annonce
     */
