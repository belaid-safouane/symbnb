 ...
 * @UniqueEntity(
 *  fields={"email"},
 * message="Un autre utilisateur s'est deja inscrit avec cette adresse email"
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\NotBlank(message="vous devez renseigner votre prénom valide !")
     */
    private $firstName;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="vous devez renseigner votre nom valide !")
     */
    private $lastName;
